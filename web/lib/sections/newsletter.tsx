...
export function Newsletter({ section }: SectionProps) {
  ...
  return (
    <section
      ...
      style={sectionStyle({ padding_top: 80, padding_bottom: 80, ...s })}
      className="bg-ink-950 pt-[var(--pt,80px)] pb-[var(--pb,80px)] text-paper"
    >
      <div className="mx-auto flex max-w-2xl flex-col items-center gap-5 px-6 text-center">
        ...
        {typeof s.text === "string" && s.text && <p className="text-body-lg text-paper/70">{s.text}</p>}
