...
const out = resolve(WEB, '../theme/assets/tailwind.min.css');
...
console.log(`theme/assets/tailwind.min.css — ${css.length} bytes, scanned theme/**/*.liquid, Google Fonts stripped`);
